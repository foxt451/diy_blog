...
class ApplicationTestCase(TestCase):
    ...
    def test_fields_have_correct_max_length(self):
        ...
        self.assertEqual(bio_max_length, models.Blogger._meta.get_field('bio').max_length)
    ...
    def test_get_absolute_url(self):
        self.assertEqual(self.application1.get_absolute_url(), f'/application/{self.application1.id}/')

class BloggerTestCase(TestCase):
    def setUp(self):
        self.user1 = models.User.objects.create_user(
            username='linds', password='ura123123', email='hiuhhHJhj@gmail.com')
        self.blogger1 = models.Blogger.objects.create(user=self.user1, bio='the author')
    ...
    def test_get_absolute_url(self):
        self.assertEqual(self.blogger1.get_absolute_url(), f'/blogger/{self.blogger1.id}/')
